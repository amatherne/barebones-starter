...
[First things first, take a look at this site's source code!](https://github.com/amatherne/barebones-starter)
...
When it came time to build a new portfolio site, I decided to step outside my comfort zone and dive into React and Next.js. Starting with the Barebones Starter code from TinaCMS, I built the entire platform from scratch, learning along the way. This journey allowed me to develop a robust platform that includes multiple custom content pipelines for blog posts, websites, and music—some of which are still in development. I also created reusable components, such as Hero sections and CTAs, that can be deployed across various pages.
