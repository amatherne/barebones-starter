...
blocks:
  - published: true
    item:
      - src: /uploads/websites/criquet/Criquet Home Page.png
        title: Criquet Shirts
        text: >
          Makers of the finest vintage-inspired golf shirts, polos, button downs
          & sweaters known to man, woman & small child.
        button:
          desktop_button:
